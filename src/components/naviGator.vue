  ...
  <div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a style="color: rgb(235, 29, 90)" class="navbar-brand" href="/"
          >ZoolGame</a
        >
        <div class="cartt">
          <a href="#">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li v-if="$store.state.isUserLoggedIn" class="balance">
            ...
            <!-- <router-link
              ...
              class="nav-item"
            >
              <i style="position: relative; top: 9px; right: 6px"></i>
              المسابقة
            </router-link> -->
            <li v-if="!$store.state.isUserLoggedIn" class="Register">
              <router-link to="/"
                ><button
                  class="rounded-md flex space-x-2 h-10 font-normal text-sm leading-3 bg-indigo-600 bg-opacity-0 hover:opacity-100 duration-100 border border-indigo-700 focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center"
                >
                  الصفحه الرئيسيه
                </button></router-link
              >
