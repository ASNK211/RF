...
export default {
  ...
  adminupdateallProduct(credentials) {
    return Api().post("products/updateall", credentials, {
      headers: {
        Authorization: "Bearer " + token,
      },
    });
  },
  adminupdateallProductdown(credentials) {
    return Api().post("products/updatealldown", credentials, {
      headers: {
        Authorization: "Bearer " + token,
      },
    });
  ...
  // competiton
  competiton(credentials) {
    return Api().post("/competiton/", credentials, {
      headers: {
        Authorization: "Bearer " + token,
      },
    });
  ...
  getcompetiton() {
    return Api().get("/competiton/", {
      headers: {
        Authorization: "Bearer " + token,
      },
    });
  },
  getUsercompetiton(id) {
    return Api().get(`/competiton/finda/${id}`, {
      headers: {
        Authorization: "Bearer " + token,
      },
    });
